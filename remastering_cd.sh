...
curl -L -O https://mirror.csclub.uwaterloo.ca/archlinux/iso/2025.02.01/archlinux-2025.02.01-x86_64.iso
mount -o loop archlinux-2025.02.01-x86_64.iso /mnt
mkdir /work/{iso-root,fs-root}
...
## pacman -Sy && pacman -S --noconfirm ansible git jq debootstrap
## 
## exit
## 
## umount fs-root
...
cp -r /usr/share/archiso/configs/releng /work/releng # edit packages.x86_64

mkarchiso -v -w /work/iso-root -o /work/out /work/releng 
